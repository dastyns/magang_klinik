...
<head>
  ...
  <!--    Document Title-->
  <!-- ===============================================-->
  <title>Rumah Gigi Sidoarjo</title>
...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container"><a class="navbar-brand" href="index.php"><img src="assets/img/gallery/logo.png" width="118" alt="logo" /></a>
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
            ...
            if (isset($_SESSION["email"])) {
              if ($_SESSION["email"] == "klinik") {
                ...
                echo "<li class='nav-item px-2'><a class='nav-link' href='inputperawatan.php'>Perawatan</a></li>";
              } else {
                echo "<li class='nav-item px-2'><a class='nav-link' href='reservationList.php'>Reservasi</a></li>";
            ...
            ?>
            <!-- <li class="nav-item px-2"><a class="nav-link" href="reservationList.php">reservation</a></li>
            <li class="nav-item px-2"><a class="nav-link" href="consultation.php">consultation Dokter</a></li>
            <li class="nav-item px-2"><a class="nav-link" href="detilkonsulpasien.php">consultation Pasien</a></li> -->
          ...
          <?php
          if (isset($_SESSION["email"])) {
            echo "<a class='btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4' id='btnSignOut'>Sign Out</a>";
          } else {
            echo "<a class='btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4' id='btnSignIn' href='signin.php'>Sign In</a>";
          }
          ?>
      ...
      <div class="container">
        <div class="row min-vh-xl-100 min-vh-xxl-25">
          ...
          <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6">
            ...
            <a class="btn btn-lg btn-primary rounded-pill" id="btnAppointment" role="button">Make an Appointment</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-secondary">
      <div class="bg-holder bg-size" style="background-position:center;background-size:cover;">
      </div>
      <!--/.bg-holder-->
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-7 col-xxl-6 text-center text-md-start">
            <h2 class="fw-light font-base fs-6 fs-xxl-7"><strong>Mengapa harus livedoc?</strong></h2>
            <p class="fw-light font-base">We've built a healthcare system that puts your needs first.<br class="d-none d-sm-block" />For us, there is nothing more important than the health of <br class="d-none d-sm-block" />you and your loved ones. </p>
...
<script>
  $('body').on('click', '#btnAppointment', function() {
    $.post("WS/cek-appointment.php", {}).done(function(data) {
      if (data == "success") {
        window.location = "reservation.php";
      } else {
        alert("Silahkan Sign In terlebih dahulu!");
      }
    });
  });

  $('body').on('click', '#btnSignOut', function() {
    $.post("WS/user-signout.php", {}).done(function(data) {
      if (data == "success") {
